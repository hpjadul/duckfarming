...
module.exports = {
    catchRevertMessage     : async function(promise, expectedErrorMessage) { await tryCatch(promise, "revert " + expectedErrorMessage); },
    catchRevert            : async function(promise) { await tryCatch(promise, "revert"                                              ); },
    catchRevertLocal       : async function(promise) { await tryCatch(promise, "stack overflow"                                      ); },
